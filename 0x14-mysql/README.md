...
---
## Task 0.[Install MySQL](./0x14-mysql) 
...
## Task 1.[Let us in! mandatory](./0x14-mysql)
...
## Task 2.[If only you could see what I've seen with your eyes](./0x14-mysql)
...
## Task 3.[Quite an experience to live in fear, isn't it?](./0x14mysql)
...
## Task 4.[Setup a Primary-Replica infrastructure using MySQL](./0x14-mysql)
